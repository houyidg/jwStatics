...
public class DataGridTagChart extends AbstractGridHtmlTag {
	...
	private String gridtype = "chart"; // grid的类型,默认jqgrid
	...
	private String height = "800";// 表格高度
	...
	private int rowNum = 100; // 这个参数是要被传递到后台，树结构时候，rowNum无效
