...
<body class="white-bg"  formid="phonetypeForm" beforeSubmit="beforeSubmit">
    <form:form id="phonetypeForm" modelAttribute="data"  method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<table  class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td  class="width-15 active text-right">	
		              <label><font color="red">*</font>手机型号:</label>
		            </td>
					<td class="width-35">
				...
				<tr>
					<td  class="width-15 active text-right">	
		              <label><font color="red">*</font>价格单位:</label>
		            </td>
					<td class="width-35">
						<form:select path="priceUnit" htmlEscape="false" class="form-control"  dict="coinunit"      />
						<label class="Validform_checktip"></label>
					</td>
